...
public class FetchProductsController {
    ...
    public List<Map<String, String>> getProductsByCategory(
        ...
        List<String> filePaths = websites.stream()
                .map(website -> String.format("A:\\fashion-frenzy-spring-master\\fashion-frenzy-spring-master\\src\\main\\resources\\%s%s%s.xlsx", genderChoice, website, categoryCapitalized))
                .toList();
